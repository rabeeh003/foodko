...
const TopNav = () => {
    return (
        <>
            <div className='flex justify-between items-center sm:hidden bg-backgroundPrimary p-2 px-6'>
                <div className="w-fit">
            ...
            <div className='flex flex-col-reverse sm:flex-row justify-between gap-2 items-center pt-7 px-7'>
